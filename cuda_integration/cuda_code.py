...
extern "C" __global__ void my_kernel(float* input_domain, int input_domain_n, int input_size, int output_size, int* layer_sizes, int layer_number, float* full_weights, 
